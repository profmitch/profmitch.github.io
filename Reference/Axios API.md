...
To see GET and POST request examples, just [here to examples](#examples)
...
Default method GET request is `axios('/REST/path');`
...
Below are the properties for the config object:
...
This will do a POST request using JSON format:
