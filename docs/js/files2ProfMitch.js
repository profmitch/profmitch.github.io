...
function resolveLeadingPath(path, destPath) {
    return path.replace(/^\*[\/\\]/, `${destPath}/`);
}
async function processMoves(yamlData) {
    let matches, copyOps = [];
    { // copy operations 
        console.log("\n========== copy operations");
...
async function getYamlContent(YamlFileName) {
...
main(process.argv);
//# sourceMappingURL=files2ProfMitch.js.map